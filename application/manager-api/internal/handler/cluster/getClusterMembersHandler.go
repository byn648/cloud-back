...
func GetClusterMembersHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetClusterMembersRequest
		...
		l := cluster.NewGetClusterMembersLogic(r.Context(), svcCtx)
		resp, err := l.GetClusterMembers(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}
